...
/**
 * 作者：admin 创建时间：2017-7-6 上午10:50:06 项目名称：YiShuQiao 文件名称：MyFansDTO.java 类说明：我的关注
 */
public class MyAttentionDTO {

    private String txt_code;
    private String txt_message;
    private List<DataInfor> followInforList;
    ...
    public List<DataInfor> getDataInforList() {
        return followInforList;
    }

    public void setDataInforList(List<DataInfor> dataInforList) {
        this.followInforList = dataInforList;
    }
