...
public class FindDTO implements Serializable {
    ...
    public List<FindItem> getFindItemList() {
        return findItemList;
    }

    public void setFindItemList(List<FindItem> findItemList) {
        this.findItemList = findItemList;
    }
    ...
    public class FindItem implements Serializable {
        ...
        private String txt_userid; // 用户ID，关注时，传此ID
        ...
        private List<FindItemImageUrl> txt_imglist;// 压缩后的图片
        private List<ItemImageUrlListOriginal> ItemImageUrlListOriginal;// 原图
        ...
        public List<FindItemImageUrl> getTxt_imglist() {
            return txt_imglist;
        }

        public void setTxt_imglist(List<FindItemImageUrl> txt_imglist) {
            this.txt_imglist = txt_imglist;
        }

        public List<ItemImageUrlListOriginal> getItemImageUrlListOriginal() {
            return ItemImageUrlListOriginal;
        }

        public void setItemImageUrlListOriginal(List<ItemImageUrlListOriginal> itemImageUrlListOriginal) {
            ItemImageUrlListOriginal = itemImageUrlListOriginal;
        }

    }

    public static class ItemImageUrlListOriginal implements Serializable {
    ...
    public class FindItemImageUrl implements Serializable {
