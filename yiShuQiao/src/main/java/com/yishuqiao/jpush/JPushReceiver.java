 ...
 * @Description TODO(极光推送消息接收 用户自定义的广播接收器)
 * @Date 2017年8月2日 下午2:19:29
 */
    ...
    private static String printBundle(Bundle bundle) {
        ...
        for (String key : bundle.keySet()) {
            if (key.equals(JPushInterface.EXTRA_NOTIFICATION_ID)) {
                sb.append("\nkey:" + key + ", value:" + bundle.getInt(key) + "  1");
            } else if (key.equals(JPushInterface.EXTRA_CONNECTION_CHANGE)) {
                sb.append("\nkey:" + key + ", value:" + bundle.getBoolean(key) + "  2");
                ...
                try {
                    ...
                    while (it.hasNext()) {
                        ...
                        sb.append("\nkey:" + key + ", value: [" + myKey + " - " + json.optString(myKey) + "]" + "  3");
                    }
                ...
                sb.append("\nkey:" + key + ", value:" + bundle.getString(key) + "  4");
            }
        }
        return sb.toString();
    }
