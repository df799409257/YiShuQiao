...
public class FragmentTow extends ForResultNestedCompatFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_tow, null);
        initView(v);
        return v;
    }
                ...
                public void onSuccess(String arg0) {
                    ...
                    if (dataDTO.getTxt_code().equals("0")) {
                        ...
                        for (int i = 0; i < mDatas.size(); i++) {
                            ...
                            pages.add(
                                    FragmentPagerItem.of(mDatas.get(i).getTxt_name(), VpSimpleFragment.class, bundle));
                        }
                        ...
                        if (!MyApplication.MySharedPreferences.readFragment2().equals("")){
                            Gson gson = new Gson();
                            dataDTO = gson.fromJson(MyApplication.MySharedPreferences.readFragment2(), NewsSortDTO.class);
                            if (dataDTO.getTxt_code().equals("0")) {
