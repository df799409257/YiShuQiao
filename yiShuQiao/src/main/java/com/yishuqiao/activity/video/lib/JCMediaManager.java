...
/**
 * <p>
 * 缁熶竴绠＄悊MediaPlayer鐨勫湴锟�?,鍙湁锟�?涓猰ediaPlayer瀹炰緥锛岄偅涔堜笉浼氭湁澶氫釜瑙嗛鍚屾椂鎾斁锛屼篃鑺傜渷璧勬簮锟�?
 * </p>
 * <p>
 * Unified management MediaPlayer place, there is only one MediaPlayer instance, then there will be no more video
 * broadcast at the same time, also save resources.
 * </p>
 * Created by Nathen On 2015/11/30 15:39
 */
class JCMediaManager implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
