...
public class CommentListAdapter extends BaseAdapter {
    ...
    public CommentListAdapter(Context context, List<CommentListDTO.ReviewInforList> datas) {
        ...
        if ((datas.get(position).getTxt_ispraise()).equals("1")) {
            ...
            holder.praise_layout.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((CommentWebViewActivity) context).commitCommentPraise(position);
...
//            @Override
//            public void onClick(View v) {
//                ((CommentWebViewActivity) context).toWriterCenter(position);
//            }
//        });
