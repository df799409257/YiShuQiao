 ...
 */
public class DiscoverDetailsListViewAdapter extends BaseAdapter {

    private Context context = null;
    private List<CommentListDTO.ReviewInforList> datas = null;

    public DiscoverDetailsListViewAdapter(Context context, List<CommentListDTO.ReviewInforList> datas) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.adapter_discoverdetails_listview, null);
        ...
        holder.userIcon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(WriterPersonalCenterActivity.USERID, datas.get(position).getTxt_userid());
                intent.putExtra(WriterPersonalCenterActivity.TITLE, datas.get(position).getTxt_username());
...
//                ((DiscoverDetailsActivity) context).toWriterCenter(position);
//            }
//        });
        ...
        if ((datas.get(position).getTxt_ispraise()).equals("1")) {
            ...
            holder.praise_layout.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((DiscoverDetailsActivity) context).commitCommentPraise(position);
