 ...
 * @Description TODO(评论列表适配器)
 * @Date 2017年7月25日 上午9:57:45
 */
public class YiyuanCommentListAdapter extends BaseAdapter {

    private Context context = null;
    private List<CommentListDTO.ReviewInforList> datas = null;

    public YiyuanCommentListAdapter(Context context, List<CommentListDTO.ReviewInforList> datas) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(context).inflate(R.layout.adapter_comment_list, null);
        ...
        if ((datas.get(position).getTxt_ispraise()).equals("1")) {
            ...
            holder.praise_layout.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ((YiyuanWebViewActivity) context).commitCommentPraise(position);
...
//            @Override
//            public void onClick(View v) {
//                ((YiyuanWebViewActivity) context).toWriterCenter(position);
//            }
//        });
