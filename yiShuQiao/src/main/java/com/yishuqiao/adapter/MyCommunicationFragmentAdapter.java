...
/**
 * 作者：admin 创建时间：2017-7-6 下午1:11:26 项目名称：YiShuQiao 文件名称：MyCommunicationFragmentAdapter.java 类说明：我发起的 交流界面
 */
public class MyCommunicationFragmentAdapter extends BaseAdapter {

    private List<MyDiscoverFragmentDTO.SubmitFindList> list = null;
    private Context context = null;
    private DownLoadImage downLoadImage;

    public MyCommunicationFragmentAdapter(Context context, List<MyDiscoverFragmentDTO.SubmitFindList> list) {
