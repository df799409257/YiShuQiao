 ...
 * the {@link MultiStateView.ViewState} accordingly Every MultiStateView
...
public class MultiStateView extends FrameLayout {
    ...
    private static final int CONTENT_VIEW = 0;// 成功的view

    private static final int ERROR_VIEW = 1;// 失败的view

    private static final int EMPTY_VIEW = 2;// 空数据的view

    private static final int LOADING_VIEW = 3;// 加载中的view
