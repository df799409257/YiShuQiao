 ...
 * 作者：admin
 * <p>
 * 创建时间：2017-6-22 下午1:16:31
 * <p>
 * 项目名称：YueGuiF
 * <p>
 * 文件名称：ScrollingUtil.java
 * <p>
 * 类说明：
 */
public class ScrollingUtil {
    ...
    public static boolean isAbsListViewToTop(AbsListView absListView) {
        if (absListView != null) {
            ...
            if (absListView.getChildCount() > 0) {
                ...
                firstChildTop = absListView.getChildAt(0).getTop()
    ...
    public static boolean isRecyclerViewToTop(RecyclerView recyclerView) {
        if (recyclerView != null) {
            ...
            if (recyclerView.getChildCount() > 0) {
                ...
                ViewGroup.MarginLayoutParams layoutParams = (ViewGroup.MarginLayoutParams) recyclerView
                        .getChildAt(0).getLayoutParams();
                firstChildTop = recyclerView.getChildAt(0).getTop()
                        - layoutParams.topMargin - recyclerView.getPaddingTop();
            }
    ...
    public static boolean isStickyNavLayoutToTop(
            BGAStickyNavLayout stickyNavLayout) {
        return isScrollViewOrWebViewToTop(stickyNavLayout)
                && stickyNavLayout.isContentViewToTop();
    }
    ...
    public static boolean isScrollViewToBottom(ScrollView scrollView) {
        if (scrollView != null) {
            ...
            int realContentHeight = scrollView.getChildAt(0)
                    .getMeasuredHeight();
