...
public class BGAStickyNavLayout extends LinearLayout {
    ...
    public void onFinishInflate() {
        ...
        if (mContentView instanceof AbsListView) {
            ...
            mDirectRecyclerView.setOnScrollListener(mRvOnScrollListener);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        measureChild(mContentView, widthMeasureSpec, MeasureSpec
                .makeMeasureSpec(MeasureSpec.getSize(heightMeasureSpec) - getNavViewHeight(), MeasureSpec.EXACTLY));
    }
...
//                mNestedRecyclerView.removeOnScrollListener(mRvOnScrollListener);
                mNestedRecyclerView.setOnScrollListener(mRvOnScrollListener);
    ...
    private RecyclerView.OnScrollListener mRvOnScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            if ((newState == RecyclerView.SCROLL_STATE_IDLE || newState == RecyclerView.SCROLL_STATE_SETTLING)
                    && mRefreshLayout != null && mRefreshLayout.shouldHandleRecyclerViewLoadingMore(recyclerView)) {
    ...
    private AbsListView.OnScrollListener mLvOnScrollListener = new AbsListView.OnScrollListener() {
        ...
        public void onScrollStateChanged(AbsListView absListView, int scrollState) {
            if ((scrollState == SCROLL_STATE_IDLE || scrollState == SCROLL_STATE_FLING) && mRefreshLayout != null
