...
/**
 * Created by sks on 2015/10/22. 自定义dialog
 */
public class MyDialog extends Dialog {
    ...
    public MyDialog(Activity context, int themeResId, String title,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancel = (TextView) findViewById(R.id.txtDialogLift);
        sure = (TextView) findViewById(R.id.txtDialogRight);
